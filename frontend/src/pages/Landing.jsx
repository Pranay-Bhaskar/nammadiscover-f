            ...
            <section id="about" className="about-section" ref={aboutRef}>
                ...
                <div className="container about-inner">
                    <div className={`about-text${aboutVisible ? ' about-text--in' : ''}`}>
                        ...
                        <h2 className="section-title">{t('We started with a simple belief — the real beauty of Karnataka lies beyond popular tourist spots.', 'ನಾವು ಒಂದು ಸರಳ ನಂಬಿಕೆಯಿಂದ ಆರಂಭಿಸಿದ್ದೇವೆ — ಕರ್ನಾಟಕದ ನಿಜವಾದ ಸೌಂದರ್ಯವು ಪ್ರಸಿದ್ಧ ಪ್ರವಾಸಿ ಸ್ಥಳಗಳಿಗಿಂತ ಹೊರಗಡೆ ಇದೆ.')}</h2>
                        <p className="about-p">
                            {t(
                                ...
                                "ಅನೇಕ ಮರೆಯಾದ ರತ್ನಗಳು, ಸಣ್ಣ ಪಟ್ಟಣಗಳು ಮತ್ತು ಕುಟುಂಬದಿಂದ ನಡೆಸಲ್ಪಡುವ ವ್ಯಾಪಾರಗಳು ಇವೆ, ಅವುಗಳ ಕಥೆಗಳು ಬಹಳಷ್ಟು ಬಾರಿ ಗಮನಕ್ಕೆ ಬರುವುದಿಲ್ಲ. ನಮ್ಮ ಉದ್ದೇಶವು ಈ ಸ್ಥಳಗಳನ್ನು ಬೆಳಕಿಗೆ ತಂದು, ಅವುಗಳ ಮೂಲತ್ವ ಮತ್ತು ಸಾಂಸ್ಕೃತಿಕ ಮೌಲ್ಯವನ್ನು ಕಾಪಾಡುವುದಾಗಿದೆ.
 ಈ ವೇದಿಕೆ ನಿಮಗೆ ಕರ್ನಾಟಕವನ್ನು ಹೆಚ್ಚು ಅರ್ಥಪೂರ್ಣವಾಗಿ ಅನ್ವೇಷಿಸಲು ಸಹಾಯ ಮಾಡುತ್ತದೆ — ನಕ್ಷೆಯಲ್ಲಿ ಸ್ಥಳಗಳನ್ನು ತೋರಿಸುವುದಷ್ಟೇ ಅಲ್ಲ, ಅವುಗಳ ಹಿಂದೆ ಇರುವ ಕಥೆಗಳನ್ನೂ ಹಂಚಿಕೊಳ್ಳುತ್ತದೆ. ಪರಿಶೀಲಿಸಲಾದ ವೀಡಿಯೊಗಳು ಮತ್ತು ಅನ್ವೇಷಕರಿಂದ ಹಂಚಿಕೊಳ್ಳಲ್ಪಟ್ಟ ನಿಜವಾದ ಅನುಭವಗಳ ಮೂಲಕ, ನೀವು ಸ್ಥಳಗಳನ್ನು ಅವುಗಳ ನಿಜ ಸ್ವರೂಪದಲ್ಲಿ ನೋಡಬಹುದು.
"
                            )}
                        </p>
                        <p className="about-p">
                            {t(
                                "We also make it easier to connect with local shopkeepers, artisans, and communities, so your journey goes beyond visiting — it becomes a genuine interaction with the people who make these places special.

By focusing on authenticity, trust, and storytelling, we aim to create a space where travel is not just about destinations, but about understanding culture, supporting local businesses, and discovering the unseen side of Karnataka.",
                                "ನಾವು ಸ್ಥಳೀಯ ಅಂಗಡಿಕಾರರು, ಕಲಾವಿದರು ಮತ್ತು ಸಮುದಾಯಗಳೊಂದಿಗೆ ಸಂಪರ್ಕ ಸಾಧಿಸುವುದನ್ನು ಸಹ ಸುಲಭಗೊಳಿಸುತ್ತೇವೆ, ಆದ್ದರಿಂದ ನಿಮ್ಮ ಪ್ರಯಾಣವು ಕೇವಲ ಭೇಟಿ ನೀಡುವುದನ್ನು ಮೀರಿ — ಈ ಸ್ಥಳಗಳನ್ನು ವಿಶೇಷವಾಗಿಸುವ ಜನರೊಂದಿಗೆ ನಿಜವಾದ ಸಂವಹನವಾಗುತ್ತದೆ.
