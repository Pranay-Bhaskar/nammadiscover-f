...
const Hero = () => {
  ...
  const stats = [
    { num: '70+', label: t('Verified Spots', 'ಪರಿಶೀಲಿಸಿದ ಸ್ಥಳಗಳು') },
    { num: '20+', label: t('Happy Travelers', 'ಸಂತುಷ್ಟ ಪ್ರಯಾಣಿಕರು') },
    { num: '5+', label: t('Local Guides', 'ಸ್ಥಳೀಯ ಮಾರ್ಗದರ್ಶಕರು') },
    { num: '4.2★', label: t('Avg Rating', 'ಸರಾಸರಿ ರೇಟಿಂಗ್') },
  ];
